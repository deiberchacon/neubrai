    ...
    return (
      ...
      >
        {message.role === 'model' ? (
          ...
          <Markdown components={markdownConfig}>
...
const markdownConfig = {
  ...
  ol({ node, ...rest }: any) {
    return <ol className="mt-2 mb-3 ml-2 list-decimal pl-5" {...rest} />;
  },
  ul({ node, ...rest }: any) {
    return <ul className="mt-2 mb-3 ml-2 list-disc pl-5" {...rest} />;
  },
  hr({ node, ...rest }: any) {
    return <hr className="my-8 border-t-2 border-slate-200" {...rest} />;
  },
};
